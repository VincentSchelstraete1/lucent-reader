...
def assemble_note(filename: str, source_type: str, page_count: int, blocks: list[LearningBlock], decisions: dict[str, RepresentationDecision], objects: dict[str, LearningObject]) -> GeneratedNote:
