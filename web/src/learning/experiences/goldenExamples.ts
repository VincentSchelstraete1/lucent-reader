...
export const gramSchmidtGolden: StepThroughMechanismData = {
  ...
  stages: [
    ...
    { title: "Expose the shared component", explanation: "The projection is the part of v₂ already pointing along u₁. It is the overlap we need to remove.", equation: "projᵤ₁(v₂)", activeEntityIds: ["v2", "projection"], vectors: [{ id: "v2", x: 185, y: 105, color: "#bf6b3a", label: "v₂" }, { id: "projection", x: 185, y: 0, color: "#9a7b27", dashed: true, label: "projection" }] },
