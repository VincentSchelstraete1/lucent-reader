...
export type LearnVisualSpec = { type: "diagram" | "process" | "labeling" | "ordering" | "prediction" | "step_through"; title: string; purpose: string; nodes: Array<{ id: string; label: string; detail?: string | null; group?: string | null }>; edges: Array<{ source: string; target: string; label?: string | null }>; stages: Array<{ title?: string; explanation?: string; activeNodeIds?: string[] }>; answerId?: string | null }
